# Copilot Instructions for NetDashboard
NetDashboard is a native Windows desktop app (C#, WPF, .NET 8) that combines DNS diagnostics, mail server discovery, network connectivity checks, and system information in a single dark-themed, trilingual interface.
## Code style
